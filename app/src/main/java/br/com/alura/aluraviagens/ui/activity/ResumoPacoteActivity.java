...
public class ResumoPacoteActivity extends AppCompatActivity {
    ...
    private void carregaPacoteRecebido() {
        ...
        if (intent.hasExtra(CHAVE_PACOTE)) {
            ...
            inicializaCampo(pacote);
            comfiguraBotao(pacote);
        }
    }

    private void comfiguraBotao(Pacote pacote) {
    ...
    private void inicializaCampo(Pacote pacote) {
        mostraLocal(pacote);
        mostraImagem(pacote);
        mostraDias(pacote);
        mostraPreco(pacote);
    ...
    private void mostraLocal(Pacote pacote) {
        TextView local = findViewById(R.id.reumos_pacote_local);
